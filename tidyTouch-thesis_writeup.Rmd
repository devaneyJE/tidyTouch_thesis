...
abstract: |
  abstract is going here. title page being rewritten in LaTeX to adhere to thesis submission format
...
**still working with code to see where to include section on `shinymeta` with demonstration; will likely be placed here**
